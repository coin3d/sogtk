...
static struct key1map GtkToSoMapping[] = {
/*
...
*/
  {0, SoKeyboardEvent::ANY} // Ends table
};
...
SoGtkKeyboard::SoGtkKeyboard(sogtkEventMask mask)
{
  this->eventmask = mask;
  this->kbdevent = NULL;
}
...
*/
void
SoGtkKeyboard::enable(GtkWidget * /*w*/, SoGtkEventHandler /*f*/, void * /*data*/)
{
  // TODO: implement
}
...
*/
void
SoGtkKeyboard::disable(GtkWidget * /*w*/, SoGtkEventHandler /*f*/, void * /*data*/)
{
  // TODO: implement
}
...
*/
const SoEvent *
SoGtkKeyboard::translateEvent(GdkEvent * event)
{
/*
  if (((event->type() == Event_KeyPress) ||
...
#if SoGtk_DEBUG
      SoDebugError::postWarning("SoGtkKeyboard::translateEvent",
    ...
    this->setEventPosition(this->kbdevent,
                           ...
                           SoGtkDevice::getLastEventPosition().x(),
                           SoGtkDevice::getLastEventPosition().y());
